...
!!! info "Bu sayfa hazırlanıyor"
    ...
    - Girdi doğrulama, format string, arabellek ve tamsayı taşması, serbest bırakılmış belleğin kullanımı
    - SEI CERT C/C++; sanitizer'lar (ASan, UBSan) ve fuzzing'e giriş
    - Derleyici ve işletim sistemi korumaları: stack canary, FORTIFY, PIE/ASLR, DEP/NX, RELRO, CFI
    - Sembol görünürlüğü, sürümde günlüklemenin kaldırılması, kontrol akışı düzleştirme, dize gizleme
