...
??? info "Ders akışı (öğretim üyesi için zaman planı)"
    ...
    | 1:20–1:50 | 7–8 | Güvensiz seri durumdan çıkarma **Demo 7**; XML, şablon ve diğer enjeksiyonlar |
    | 1:50–2:00 | Ara | |
    | 2:00–2:15 | 9 | Bayt kodu ve tersine derleme — **Demo 4** |
    | 2:15–2:40 | 10–11 | ProGuard / R8, gelişmiş kurallar; dize gizleme ve dinamik yöntem çağrısı — **Demo 5** |
    | 2:40–2:55 | 12 | Bağımlılık güvenliği ve SBOM — **Demo 6** |
    | 2:55–3:00 | 13+ | Proje adımı, kendini sınama |
...
| 5 | **Bağımlılık hijyeni** | Sınıf yolunda kullanılmayan kütüphane bırakmamak (12. bölüm) |
...
## 9. Bayt kodu ve tersine derleme
...
## 10. ProGuard ve R8: küçültme, iyileştirme, gizleme
...
## 11. Dize gizleme ve dinamik yöntem çağrısı
...
## 12. Bağımlılık güvenliği ve yazılım malzeme listesi (SBOM)
...
- [ ] Projenizde bir betik ya da Java bileşeni varsa, gizleme gereksinimini ve `-keep` kurallarını S6 bölümüne ekleyin.
