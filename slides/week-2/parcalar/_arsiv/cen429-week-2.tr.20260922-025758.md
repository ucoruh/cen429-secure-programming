...
**Bunu Demo 1'de kendi gözümüzle göreceğiz.**
...
# Demo 1 — Hash kırılgan, desen dayanıklı
...
# Demo 1 — Emülasyon hepsini çözer
...
# Demo 2 — Sıcak bölge ve fidye izi
...
# Demo 4 — Savunma maliyeti artırır
...
- [ ] En kritik varlığa bir **saldırı ağacı** (Demo 4 biçimi); en ucuz yol + en etkili önlem.
...
<!--
Konuşma notu: Cevaplar ders sitesinde acilir kutularda. Quiz-1 (8. hafta) bu tarz kisa cevap ve kod okuma icerir.
-->
