...
| 2 | Komut **Demo 2** · Yol geçişi **Demo 3** · Seri durumdan çıkarma **Demo 7** · XXE, XSS, şablon · Python/JS, ReDoS |
| 3 | Bayt kodu **Demo 4** · ProGuard / R8 · Dize gizleme, yansıma **Demo 5** · Android R8, ölçme · SBOM **Demo 6** · Proje |
...
- [ ] Betik ya da Java bileşeni varsa: gizleme gereksinimi ve `-keep` kuralları → S9
